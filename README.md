...
If you want to keep the repo lighter, you can also choose not to commit `eval/results/`, but I left the saved results in place because they document how the winner was selected.
